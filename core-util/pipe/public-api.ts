...
export * from './array/merge-pipe';
export * from './array/slice-pipe';
export * from './array/sort-pipe';

export * from './date/distance-in-words-pipe'; // xxx
export * from './date/formatted-interval-pipe';
export * from './date/formatted-period-pipe'; // xxx
export * from './date/local-date.pipe';
...
export * from './string/abbreviate-pipe'; // xxx
export * from './string/reverse-pipe';
